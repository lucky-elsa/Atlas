...
module.exports = {
  ...
  react: "🍁",
  start: async (Miku, m, { text, prefix, args, reply }) => {
    ...
    for (let res of jsonData.results) {
        let encmedia = await Miku.sendImageAsSticker(m.from, res.url, m, { packname: global.packname, author: global.author, categories: res.tags });
